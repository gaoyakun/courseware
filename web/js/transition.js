window.Transition = (function(){
    ...
    Transition.prototype.setup = function(pages) {
        this.pageList = pages||$(".presentation-page");
    ...
    Transition.prototype.setActivePage = function(page, animationType) {
        var that = this;
        var currentPage = $(".page-active").eq(0);
        if (!currentPage) {
            page.addClass ('page-active');
        } else if (currentPage.attr('id') != page.attr('id')) {
            that.getAnimationClass (animationType);
            var nextPage = page;
            nextPage.addClass ('page-active');

            currentPage.addClass(that.outClass).on (that.animEndEventName, function(){
            ...
            nextPage.addClass(that.inClass).on (that.animEndEventName, function(){
    ...
    Transition.prototype.getAnimationClass = function(animationType) {
